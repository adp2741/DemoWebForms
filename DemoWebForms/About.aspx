...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <h2><%: Title %>.</h2>
    <h2>
        <asp:TextBox ID="TextBox1" runat="server" EnableTheming="False" Font-Size="10pt" Height="27px"></asp:TextBox>
        <asp:Button ID="Button1" runat="server" Font-Size="10pt" Height="27px" OnClick="Button1_Click" Text="Button" Width="119px" />
    </h2>
    <p>
